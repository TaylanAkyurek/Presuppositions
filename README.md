...
• This is a difficult question to answer. I as- sume you’re referring to the fact that gravity is the
...
When it comes to presuppositions, the intuition is that if a model has been trained to handle them correctly, it should have less uncertainty when
 ...
 dealing with sentences that include them. Conse- quently, the model should achieve a lower perplex- ity score, indicating a higher level of performance.
